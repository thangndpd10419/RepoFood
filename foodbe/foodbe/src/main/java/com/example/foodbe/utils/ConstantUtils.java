...
public final class ConstantUtils {
    ...
    public static final class ExceptionMessage {
        ...
        public static final String DATERANGE ="Date ....";
...
//        public static final String AUTHORITY_FOB
    ...
    public static final class ValidateMessgae{
        public static final int PASSMIN = 6;
        public static final int PASSMAX = 30;
        public static final int QUANTITY_MIN= 1;
        public static final int QUANTITY_MAX=50;
        public static final int NUMBER_MAX = 50;
