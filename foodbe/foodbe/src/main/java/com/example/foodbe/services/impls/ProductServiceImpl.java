...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ProductResponseDTO updateById(UpdateProductDTO updateProductDTO) {
       Product product= productRepository.findById(updateProductDTO.getId())
               .orElseThrow(()-> new NotFoundException(ConstantUtils.ExceptionMessage.NOT_FOUND+updateProductDTO.getId()));
