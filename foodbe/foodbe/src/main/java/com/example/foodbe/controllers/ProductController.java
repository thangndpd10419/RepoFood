...
public class ProductController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<ProductResponseDTO>> updateById( @Valid @RequestBody UpdateProductDTO updateProductDTO){
        return ResponseEntity.ok(ApiResponse.success(productService.updateById( updateProductDTO)));
    }
